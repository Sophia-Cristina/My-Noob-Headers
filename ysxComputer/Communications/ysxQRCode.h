...
/*#####################
####### By Sophia Cristina
####### QR Code is a big class, so i made a special header for it.
#####################*/
...
public:
	...
	*/
	...
	ysxCOMMU_QRCode(unsigned char Version, unsigned char QRColor[3], unsigned char BGColor[3])
	{
		Ver = Version;
