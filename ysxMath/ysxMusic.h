...
double ysxMUS_MIDItoFreq(float MIDI, uint16_t Temper, double BaseFreq) { return(pow(2.0, ((double)MIDI / Temper)) * BaseFreq * 0.0185814); } // Reduced way but fixed to 'A3 = 57'
