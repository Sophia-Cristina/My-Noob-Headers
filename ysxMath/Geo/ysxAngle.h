...
constexpr double ysxGEO_RadAct(double Rad) { return(HPI - Rad); } // Acute | In and Out in "Degrees".
constexpr double ysxGEO_RadObt(double Rad) { return(PI - Rad); } // Obtuse | In and Out in "Degress".
constexpr double ysxGEO_RadWhl(double Rad) { return(TAU - Rad); } // Whole | In and Out in "Degrees".
