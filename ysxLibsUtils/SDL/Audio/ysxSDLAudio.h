...
But it is just a call that goes to the first sample position after it reaches the last sample, known as: 'circular buffer'.
I have not named "loop" because the "LoopCall" is based on looping the buffer after reaching the end, but it does it
abruptly and not by a modulo!
