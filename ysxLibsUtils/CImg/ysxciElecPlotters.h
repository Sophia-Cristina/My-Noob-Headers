...
// * Add ohmns *
template<size_t SigSize> class ysxCIMG_ELEC_LED : public ysxELEC_Component
{
public:
    uint8_t LEDSize;
    double Volts, x;
    ...
    ysxCIMG_ELEC_LED(uint8_t LED_Diameter, double Voltage)
    {
...
template<size_t SigSize> class ysxCIMG_ELEC_LEDArray : public ysxELEC_Component
{
public:
    uint8_t LEDSize;
    ...
    // TAKE CARE WITH THE AMMOUNT OF COLLUMS, IT IS !!! A COLLUM PER BIT, NOT BYTE !!!:
    ysxCIMG_ELEC_LEDArray(uint8_t LED_Diameter, uint8_t Bytes, uint16_t iRows, double Voltage)
    {
