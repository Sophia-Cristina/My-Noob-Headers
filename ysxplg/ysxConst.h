...
const double Root2 = 1.414213562373095; // Square root of 2
...
const double Center4QuartCircArea = 0.31514674362772; // 0.3151467436277204526267681195873; // In a square of side 1, 4 quarter circles in the four directions cross each other, the center figure have this area
