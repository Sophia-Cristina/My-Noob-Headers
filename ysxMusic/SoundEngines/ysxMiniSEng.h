...
Slight modification of the classes 'SigStream' and 'SigSynth',
...
public:
	...
	*/
	...
	void StartEngine()
	{
		...
		if (Device < 0)
		{
			if (bLOG) { LOG += "!!! FAILED TO OPEN AUDIO !!!\n"; }
	...
	void PauseEngine() { SDL_PauseAudio(1); if (bLOG) { LOG += "Audio paused, 'n = " + std::to_string(RAM->n) + "'!\n"; } }
