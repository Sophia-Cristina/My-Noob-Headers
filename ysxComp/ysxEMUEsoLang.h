...
public:
	...
	// #######
	FlipJumpCPU8b(uint8_t* ROM, uint32_t ROM_Size) { mem = ROM; ROMSize = ROM_Size; }
	~FlipJumpCPU8b() {}
	// #######
...
public:
	...
	TOGAComputer(Point<uint32_t>* RAM4096) { pm = RAM4096; pm[0] = { 0, 0 }; pm[1] = { 1, 0 }; pm[2] = { 1, 0 }; }	
	~TOGAComputer() {}
	// #######
