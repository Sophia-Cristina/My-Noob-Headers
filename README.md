...
'ysxCImg.h' header was becoming too big, do i separated the code by areas.
...
The author forgot to add his name in the file, so, sorry for that dude! If you are the author, give me a hi (somehow)!
